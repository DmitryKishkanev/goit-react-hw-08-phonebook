...
const RegistrationFormWrapper = styled(Box)({
  margin: 'auto',
  padding: '16px 32px',
...
const RegistrationFormBox = styled(Box)`
  display: flex;
...
const RegistrationFormField = styled(TextField)`
  border-radius: 4px;
...
const RegistrationFormError = styled(Typography)`
  color: red;
  font-size: 20px;
  text-align: center;
`;
